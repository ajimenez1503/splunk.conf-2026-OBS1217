...
## Identify Your Splunk Realm

Your Splunk realm is the environment identifier used in ingest URLs. For example, if your Splunk Observability Cloud URL is `https://us0.signalfx.com`, your realm is `us0`.