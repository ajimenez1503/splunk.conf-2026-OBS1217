...
Use the shared [ThousandEyes workshop credentials spreadsheet](https://splunk.show/obs1217-signup) to obtain your credentials. If prompted, sign in with your Cisco account.
