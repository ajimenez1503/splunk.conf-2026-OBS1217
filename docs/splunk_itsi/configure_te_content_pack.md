...
If you didn't complete this by now, please follow the [workshop guide](../thousandeyes_splunk_app/test_metrics_stream_input.md) or [official documentation](https://docs.thousandeyes.com/product-documentation/integration-guides/custom-built-integrations/splunk-app/itsi#stream-thousandeyes-test-data-to-splunk-itsi)
